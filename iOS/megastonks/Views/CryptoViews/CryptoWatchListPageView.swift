...
struct CryptoWatchListPageView: View {
...
struct CryptoWatchListPageView_Previews: PreviewProvider {
    static var previews: some View {
        CryptoWatchListPageView().environmentObject(AppObjects())
